...
export default {
  ...
  methods: {
    ...
    inviteUser() {
      ...
      this.$store
        .dispatch("photofixations/inviteMultipartUser", formData)
        .then(() => {
          this.invitedUser = {};
    ...
    addConstruction() {
      ...
      if (this.newConstruction.id === undefined) {
        this.$store
          .dispatch("photofixations/addConstruction", this.newConstruction)
          .then(() => {
        ...
        this.$store
          .dispatch("photofixations/updateConstruction", formData)
          .then(() => {
            this.showAddModal = false;
    ...
    editConstruction(item) {
      this.$store.dispatch("photofixations/getConstruction", item).then(() => {
