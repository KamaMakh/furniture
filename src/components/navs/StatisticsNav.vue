          ...
          >
            ...
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M16 2H15V0H13V2H5V0H3V2H2C0.9 2 0 2.9 0 4V18C0 19.1 0.9 20 2 20H16C17.1 20 18 19.1 18 18V4C18 2.9 17.1 2 16 2ZM16 18H2V8H16V18ZM2 4V6H16V4H2ZM6 10V12H4V10H6ZM6 16V14H4V16H6Z"
                fill="#868686"
              />
